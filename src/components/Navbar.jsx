...
function Navbar() {
  return (
    ...
    flex justify-between mt-4 pr-8 tablet:pr-0 tablet:mt-0 laptop:mt-4 desktop:mt-8 pl-8 laptop:pl-12 w-full items-center absolute translate-x-1/2 right-1/2 text-white "
    >
      <img src="../src/assets/shared/logo.svg" alt="logo" className="block" />
